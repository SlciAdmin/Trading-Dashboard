...
// ✅ NEW: Helper to get Current Capital (Deposit + P&L)
...
function updateSidebarCapital() {
    ...
    // ✅ UPDATED: Show Current Capital (Deposit + P&L) in sidebar
    ...
    // ✅ UPDATED: Show Current Capital in KPI card
...
function validateFormCapital() {
    // ✅ UPDATED: Validate against Current Capital (Deposit + P&L)
    const currentCapital = getCurrentCapital();
...
// ✅ UPDATED: KPI card now shows Current Capital (Deposit + P&L)
const currentCapital = getCurrentCapital();
set('kpiCap', fmt.currency(currentCapital, 0));
...
// ✅ CAPITAL LIMIT CHECK (Updated to use Current Capital)
const currentCapital = getCurrentCapital();
const invested = parseFloat(getv('fCapital'));
...
// Check if new total would exceed current capital
